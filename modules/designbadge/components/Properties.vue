...
const openSections = ref({
  ...
  avatar: false, // Geometry starts open
...
// Watch and update store when relevant properties change
watch(
  [size, radius, shape, customClipPath, showBorder, showRing, avatar_src],
  () => {
    store.currentProperties = {
      ...store.currentProperties,
      avatar: {
        showBorder: showBorder.value,
        showRing: showRing.value,
        avatar_src: avatar_src.value,
